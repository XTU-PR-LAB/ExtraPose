...
def concate_params( pose3d, pose2d, camera_params):
  pass


def caculate_bone_length(pose3d):
  parents = [0, 1, 2, 0, 4, 5, 0, 7, 8, 8, 10, 11, 8, 13,14]
  dists = pose3d[1:, :] - pose3d[parents[:], :]
  bone_lengths = np.linalg.norm(dists, axis=1)
  return bone_lengths
