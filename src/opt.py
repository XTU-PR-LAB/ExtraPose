...
class Options:
    ...
    def _initial(self):
        ...
        #                     General options
        # ===============================================================
        self.parser.add_argument('--data_dir',       type=str, default='data/h36m/', help='path to dataset')
        self.parser.add_argument('--cameras_path',   type=str, default='data/h36m/cameras.h5', help='Directory to load camera parameters')
        self.parser.add_argument('--camera_frame',  type=bool,default=True, help="Convert 3d poses to camera coordinates")
        self.parser.add_argument('--exp',            type=str, default='test', help='ID of experiment')
        self.parser.add_argument('--ckpt',           type=str, default='checkpoint/train', help='path to save checkpoint')
        self.parser.add_argument('--load',           type=str, default='checkpoint/train/test/ckpt_last.pth.tar', help='path to load a pretrained checkpoint')

        self.parser.add_argument('--predict_14',     type=bool, default=False, help="predict 14 joints")
        self.parser.add_argument('--resume',         type=bool, default= False, help='resume to train')
        self.parser.add_argument('--test',           type=bool, default= False, help='test')
        ...
        self.parser.add_argument('--batch_size',     type=int, default=64, help='Batch size to use during training')

        # ===============================================================
        #                     Running options
        # ===============================================================
        self.parser.add_argument('--use_hg',         type=bool, default=True, help='whether use 2d pose from hourglass')
        self.parser.add_argument('--evaluateActionWise',     type=bool, default=True, help='The dataset to use either h36m or heva')
        self.parser.add_argument('--sample',         type=bool,   default=False, help='Set to True for sampling.')
        ...
        self.parser.add_argument('--procrustes',     type=bool, default=True, help='use procrustes analysis at testing')
